  ...
  <!--================ Start Blog Post Area =================-->
                ...
                <div class="comment-form" id="comment-custom" style="margin-left: 250px;">
                    ...
                    <form method="post" onsubmit="return doCheck()">
                    	...
                    	<input type="hidden" name="userPassword" value="${kakaoId}">
                    	
                    	<%-- <div class="form-group form-inline">
	                    	<div class="form-group col-lg-6 col-md-6 name">
	                          <input type="text" class="form-control" name="userId" id="userId" placeholder="아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '아이디'" required="required" value=" ${kakaoId}" disabled>
	                        </div>
                        </div> --%>
                        
                        <div class="form-group form-inline">
		                    <div class="form-group col-lg-6 col-md-6 name">
		                          <input type="text" class="form-control" placeholder="아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '아이디'" required="required" value="kakao ID : ${kakaoId}" disabled>
		                    </div>
	                    </div>
                        <div class="form-group form-inline">
		                    <div class="form-group col-lg-6 col-md-6 name">
	                    ...
	                    <div class="form-group col-lg-6 col-md-6 name">
	                          <input type="text" class="form-control" name="storeName" id="storeName" maxlength="10" placeholder="상호명" onfocus="this.placeholder = ''" onblur="this.placeholder = '상호명'" required="required">
	                    </div>
